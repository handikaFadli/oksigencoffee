  ...
  <div class="toolbar" id="kt_toolbar">
    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
      <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
        <!--Start Title-->
        <h1 class="text-dark fw-bold my-1 fs-2">Products <small class="text-muted fs-6 fw-normal ms-1"></small></h1>
        <!--End Title-->
            ...
            <div class="card-title">
              ...
              <form action="">
                <div class="d-flex align-items-center position-relative my-1">
                  ...
                  <i class="ki-duotone ki-magnifier fs-3 position-absolute ms-4"><span class="path1"></span><span class="path2"></span></i> <input type="text" class="form-control form-control-solid w-250px ps-12" placeholder="Search Product" autocomplete="off" name="search" value="{{ request('search') }}" />
                </div>
              </form>
              <!--End Search-->
            </div>
